...
#include "nesl_rtw.h"
#include "machine_y_430a60f0_1.h"
#include "machine_y_430a60f0_1_gateway.h"

void machine_y_430a60f0_1_gateway(void)
{
  ...
  machine_y_430a60f0_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("machine_y/Solver Configuration2_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
