 ...
 */
/* machine_y_4d193148_1_ds.c - body for module machine_y_4d193148_1_ds */

#include "ne_ds.h"
#include "machine_y_4d193148_1_ds_log.h"
#include "machine_y_4d193148_1_ds_obs_act.h"
#include "machine_y_4d193148_1_ds_obs_il.h"
#include "machine_y_4d193148_1_ds_tdxf_p.h"
#include "machine_y_4d193148_1_ds_obs_all.h"
#include "machine_y_4d193148_1_ds_acon_p.h"
#include "machine_y_4d193148_1_ds_obs_exp.h"
...
static NeEquationData s_equation_data[6] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "machine_y/DC Motor", 1U, 0U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "machine_y/DC Motor", 1U, 1U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "machine_y/Ideal Rotational Motion Sensor", 1U, 2U, TRUE, 1.0, "1", }, { "",
    0U, 8, NE_EQUATION_DOMAIN_TIME,
    "machine_y/Ideal Translational Motion Sensor", 1U, 3U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "machine_y/Mass", 1U, 4U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "machine_y/Translational Spring", 1U,
    5U, TRUE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData s_icr_data[4] = { { "", 0U, 0, "machine_y/DC Motor", 1U, 0U, },
  { "", 0U, 0, "machine_y/DC Motor", 1U, 1U, }, { "", 0U, 0,
    "machine_y/Translational Damper", 1U, 2U, }, { "", 0U, 0,
    "machine_y/Translational Damper1", 1U, 3U, } };
...
static NeVariableData s_variable_data[6] = { { "DC_Motor.i_L", 0U, 0,
    "machine_y/DC Motor", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Current", }, { "DC_Motor.w", 0U, 0,
    "machine_y/DC Motor", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_NONE, "Angular velocity", }, { "Mass.v", 0U, 0,
    "machine_y/Mass", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Velocity", }, { "Translational_Spring.x", 0U, 0,
    "machine_y/Translational Spring", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Deformation", }, {
    "Ideal_Rotational_Motion_Sensor.phi", 0U, 0,
    "machine_y/Ideal Rotational Motion Sensor", 1.0, "1", 0.0, TRUE, FALSE, { 1,
      "1x1" }, NE_INIT_MODE_MANDATORY, "Angle", }, {
    "Ideal_Translational_Motion_Sensor.x", 0U, 0,
    "machine_y/Ideal Translational Motion Sensor", 1.0, "1", 0.0, TRUE, FALSE, {
      1, "1x1" }, NE_INIT_MODE_MANDATORY, "Position", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[93] = { {
    "Controlled_Voltage_Source.i", "machine_y/Controlled Voltage Source", { 1,
      "1x1" }, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Controlled_Voltage_Source.n.v", "machine_y/Controlled Voltage Source", { 1,
      "1x1" }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Controlled_Voltage_Source.p.v", "machine_y/Controlled Voltage Source", { 1,
      "1x1" }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Controlled_Voltage_Source.v", "machine_y/Controlled Voltage Source", { 1,
      "1x1" }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Controlled_Voltage_Source.vT", "machine_y/Controlled Voltage Source", { 1,
      "1x1" }, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "vT", }, { "DC_Motor.C.w",
    "machine_y/DC Motor", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "DC_Motor.H.T", "machine_y/DC Motor", { 1, "1x1" }, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Temperature", }, { "DC_Motor.R.w",
    "machine_y/DC Motor", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "DC_Motor.armature_winding_fault_factor", "machine_y/DC Motor", { 1, "1x1" },
    ...
    "DC_Motor.private.w_private", "machine_y/DC Motor", { 1, "1x1" }, "rpm", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Angular velocity", }, {
    "DC_Motor.energyStoredKinetic", "machine_y/DC Motor", { 1, "1x1" }, "J", 1.0,
    "kg*m^2/s^2", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Stored mechanical energy", }, {
    "DC_Motor.i_L", "machine_y/DC Motor", { 1, "1x1" }, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "DC_Motor.energyStoredMagnetic", "machine_y/DC Motor", { 1, "1x1" }, "J",
    1.0, "A^2*H", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Stored magnetic energy", }, {
    "DC_Motor.ohmicLosses", "machine_y/DC Motor", { 1, "1x1" }, "A^2*Ohm", 1.0,
    "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "ohmicLosses", }, {
    "DC_Motor.powerExternalThermal", "machine_y/DC Motor", { 1, "1x1" }, "W",
    1.0, "kW", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "External thermal power", }, {
    "DC_Motor.power_dissipated", "machine_y/DC Motor", { 1, "1x1" }, "W", 1.0,
    "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Dissipated power", }, {
    "Electrical_Reference.V.v", "machine_y/Electrical Reference", { 1, "1x1" },
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Gear_Box.O.w",
    "machine_y/Gear Box", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Gear_Box.S.w", "machine_y/Gear Box", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Gear_Box.t_in", "machine_y/Gear Box", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Input shaft incoming torque", }, {
    "Gear_Box.t_out", "machine_y/Gear Box", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output shaft incoming torque", }, {
    "Ideal_Force_Source.C.v", "machine_y/Ideal Force Source", { 1, "1x1" },
    ...
    "machine_y/Ideal Force Source", { 1, "1x1" }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, { "Ideal_Force_Source.S",
    "machine_y/Ideal Force Source", { 1, "1x1" }, "N", 1.0, "N",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "machine_y/Ideal Rotational Motion Sensor", { 1, "1x1" }, "rad", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "A", }, {
    "Ideal_Rotational_Motion_Sensor.C.w",
    "machine_y/Ideal Rotational Motion Sensor", { 1, "1x1" }, "rad/s", 1.0,
    ...
    "machine_y/Ideal Rotational Motion Sensor", { 1, "1x1" }, "rad/s^2", 1.0,
    ...
    "Ideal_Rotational_Motion_Sensor_W0", "machine_y/PS-Simulink\nConverter1", {
    ...
    "machine_y/Ideal Translational Motion Sensor", { 1, "1x1" }, "m/s^2", 1.0,
    ...
    "machine_y/Ideal Translational Motion Sensor", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Ideal_Translational_Motion_Sensor.P",
    "machine_y/Ideal Translational Motion Sensor", { 1, "1x1" }, "m", 1.0, "m",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "Ideal_Translational_Motion_Sensor_P0", "machine_y/PS-Simulink\nConverter",
      { 1, "1x1" }, "mm", 1.0, "m", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Translational_Motion_Sensor_P0", }, { "Mass.M.v", "machine_y/Mass", {
      1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Velocity", }, { "Mass.N.v", "machine_y/Mass", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Velocity", }, { "Mass.v",
    "machine_y/Mass", { 1, "1x1" }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_MANDATORY, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Velocity", }, { "Mass.energyStoredKinetic", "machine_y/Mass", { 1, "1x1" },
    ...
    "machine_y/Mass", { 1, "1x1" }, "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force",
  }, { "Mass.f_MN", "machine_y/Mass", { 1, "1x1" }, "N", 1.0, "N",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "f_MN", }, {
    "Mechanical_Rotational_Reference.W.w",
    "machine_y/Mechanical Rotational Reference", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Rotational_Reference1.W.w",
    "machine_y/Mechanical Rotational Reference1", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Translational_Reference.V.v",
    "machine_y/Mechanical Translational Reference", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Mechanical_Translational_Reference1.V.v",
    "machine_y/Mechanical Translational Reference1", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Mechanical_Translational_Reference2.V.v",
    "machine_y/Mechanical Translational Reference2", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Simulink_PS_Converter2_output0", "machine_y/Simulink-PS\nConverter2", { 1,
  ...
  }, { "Simulink_PS_Converter_output0", "machine_y/Simulink-PS\nConverter", { 1,
      "1x1" }, "1", 1.0, "1", NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Simulink_PS_Converter_output0",
  }, { "Translational_Damper.C.v", "machine_y/Translational Damper", { 1, "1x1"
    }, "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper.H.T", "machine_y/Translational Damper", { 1, "1x1" },
    "K", 1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Temperature", }, {
    "Translational_Damper.R.v", "machine_y/Translational Damper", { 1, "1x1" },
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper.faultExtTrigger", "machine_y/Translational Damper", {
  ...
  { "Translational_Damper.temperature", "machine_y/Translational Damper", { 1,
      "1x1" }, "K", 1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Temperature", }, {
    "Translational_Damper.f", "machine_y/Translational Damper", { 1, "1x1" },
    "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Translational_Damper.v",
    "machine_y/Translational Damper", { 1, "1x1" }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper.powerExternalThermal",
    "machine_y/Translational Damper", { 1, "1x1" }, "W", 1.0, "kg*m^2/s^3",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "External thermal power", }, {
    "Translational_Damper1.C.v", "machine_y/Translational Damper1", { 1, "1x1" },
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper1.H.T", "machine_y/Translational Damper1", { 1, "1x1" },
    "K", 1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Temperature", }, {
    "Translational_Damper1.R.v", "machine_y/Translational Damper1", { 1, "1x1" },
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper1.faultExtTrigger", "machine_y/Translational Damper1",
      { 1, "1x1" }, "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "External fault trigger", },
  { "Translational_Damper1.temperature", "machine_y/Translational Damper1", { 1,
      "1x1" }, "K", 1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Temperature", }, {
    "Translational_Damper1.f", "machine_y/Translational Damper1", { 1, "1x1" },
    "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Translational_Damper1.v",
    "machine_y/Translational Damper1", { 1, "1x1" }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Damper1.powerExternalThermal",
    "machine_y/Translational Damper1", { 1, "1x1" }, "W", 1.0, "kg*m^2/s^3",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "External thermal power", }, {
    "Translational_Spring.C.v", "machine_y/Translational Spring", { 1, "1x1" },
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Spring.R.v", "machine_y/Translational Spring", { 1, "1x1" },
    "m/s", 1.0, "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, {
    "Translational_Spring.f", "machine_y/Translational Spring", { 1, "1x1" },
    "N", 1.0, "N", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Translational_Spring.v",
    "machine_y/Translational Spring", { 1, "1x1" }, "m/s", 1.0, "m/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, { "Translational_Spring.x",
    "machine_y/Translational Spring", { 1, "1x1" }, "m", 1.0, "m",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Deformation", }, {
    "Translational_Spring.energyStoredElastic", "machine_y/Translational Spring",
    { 1, "1x1" }, "J", 1.0, "kg*m^2/s^2", NE_NOMINAL_SOURCE_NONE,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE,
    "Elastic energy", }, { "Wheel_and_Axle.A.w", "machine_y/Wheel and Axle", { 1,
    ...
    "Wheel_and_Axle.P.v", "machine_y/Wheel and Axle", { 1, "1x1" }, "m/s", 1.0,
    "m/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Velocity", }, { "Wheel_and_Axle.f",
    "machine_y/Wheel and Axle", { 1, "1x1" }, "N", 1.0, "N",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Force", }, { "Wheel_and_Axle.t",
    "machine_y/Wheel and Axle", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
...
static NeRange s_equation_range[6] = { { "ee.electromech.brushed.dc_motor_base",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "ee.electromech.brushed.dc_motor", 1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED,
  }, { "foundation.mechanical.sensors.angular_velocity", 78U, 9U, 78U, 22U,
    NE_RANGE_TYPE_NORMAL, }, { "foundation.mechanical.sensors.velocity", 77U, 9U,
    77U, 20U, NE_RANGE_TYPE_NORMAL, }, {
    "foundation.mechanical.translational.mass", 51U, 5U, 51U, 22U,
    NE_RANGE_TYPE_NORMAL, }, { "foundation.mechanical.translational.spring", 28U,
    5U, 28U, 15U, NE_RANGE_TYPE_NORMAL, } };

static NeRange *s_cer_range = NULL;
static NeRange s_icr_range[4] = { { "ee.electromech.brushed.dc_motor_base", 1U,
    1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "ee.electromech.brushed.dc_motor_base", 1U, 1U, 1U, 1U,
    NE_RANGE_TYPE_PROTECTED, }, { "sdl.couplings.springs.trans_damper", 72U, 31U,
    72U, 39U, NE_RANGE_TYPE_NORMAL, }, { "sdl.couplings.springs.trans_damper",
    72U, 31U, 72U, 39U, NE_RANGE_TYPE_NORMAL, } };
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mMCON_P.mNumCol = 6;
  out->mMCON_P.mNumRow = 6;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mMPAR_P.mNumCol = 6;
  out->mMPAR_P.mNumRow = 6;
  ...
  allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mMNL_P.mNumCol = 6;
  out->mMNL_P.mNumRow = 6;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mACON_P.mNumCol = 6;
  out->mACON_P.mNumRow = 6;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mACON.mN = 13;
  out->mACON.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 13);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mAPAR_P.mNumCol = 6;
  out->mAPAR_P.mNumRow = 6;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 54;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 54);
  return out;
}
...
NeDynamicSystem *machine_y_4d193148_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 93;
  ds->mNumObservableElements = 84;
  ds->mNumZcs = 0;
  ds->mNumAsserts = 0;
  ...
  input_info[0].identifier = "Simulink_PS_Converter2_output0";
  input_info[0].size.numElements = 1;
  input_info[0].size.encodedDimensions = "1x1";
  input_info[0].name = "Simulink_PS_Converter2_output0";
  input_info[0].unit = "1";
  ...
  output_info[1].identifier = "Ideal_Translational_Motion_Sensor_P0";
  output_info[1].size.numElements = 1;
  output_info[1].size.encodedDimensions = "1x1";
  output_info[1].name = "Ideal_Translational_Motion_Sensor_P0";
  output_info[1].unit = "mm";
  ...
  ds->mMethods[NE_DS_METHOD_ACON_P] = machine_y_4d193148_1_ds_acon_p;
  ...
  ds->mMethods[NE_DS_METHOD_TDXF_P] = machine_y_4d193148_1_ds_tdxf_p;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = machine_y_4d193148_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = machine_y_4d193148_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = machine_y_4d193148_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = machine_y_4d193148_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = machine_y_4d193148_1_ds_obs_il;
...
{
  static int32_T _cg_const_1[7] = { 0, 0, 1, 1, 1, 1, 2 };

  (void)t1;
  out->mTDXY_P.mNumCol = 6UL;
...
{
  (void)t1;
  out->mMDXY_P.mNumCol = 6UL;
  out->mMDXY_P.mNumRow = 2UL;
  out->mMDXY_P.mJc[0] = 0;
  out->mMDXY_P.mJc[1] = 0;
  out->mMDXY_P.mJc[2] = 0;
  out->mMDXY_P.mJc[3] = 0;
                     ...
                     NeDsMethodOutput *out)
{
  ...
  out->mY.mX[1UL] = t1->mX.mX[5UL] * 1000.0;
  (void)sys;
  (void)out;
  return 0;
}
...
{
  (void)t1;
  out->mQX_P.mNumCol = 6UL;
  out->mQX_P.mNumRow = 6UL;
  out->mQX_P.mJc[0] = 0;
  out->mQX_P.mJc[1] = 0;
  out->mQX_P.mJc[2] = 0;
  out->mQX_P.mJc[3] = 0;
...
{
  (void)t1;
  out->mDXM_P.mNumCol = 6UL;
  out->mDXM_P.mNumRow = 6UL;
  out->mDXM_P.mJc[0] = 0;
  out->mDXM_P.mJc[1] = 0;
  out->mDXM_P.mJc[2] = 0;
  out->mDXM_P.mJc[3] = 0;
...
{
  (void)t1;
  out->mMNL_P.mNumCol = 6UL;
  out->mMNL_P.mNumRow = 6UL;
  out->mMNL_P.mJc[0] = 0;
  out->mMNL_P.mJc[1] = 0;
  out->mMNL_P.mJc[2] = 0;
  out->mMNL_P.mJc[3] = 0;
...
{
  (void)t1;
  out->mMPAR_P.mNumCol = 6UL;
  out->mMPAR_P.mNumRow = 6UL;
  out->mMPAR_P.mJc[0] = 0;
  out->mMPAR_P.mJc[1] = 0;
  out->mMPAR_P.mJc[2] = 0;
  out->mMPAR_P.mJc[3] = 0;
...
static int32_T ds_mcon (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static real_T _cg_const_1[6] = { -0.0001, 3.0E-6, -1.0, -1.0, 1.0, 1.0 };
...
static int32_T ds_mcon_p (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[6] = { 1, 0, 4, 5, 2, 3 };

  (void)t1;
  out->mMCON_P.mNumCol = 6UL;
  out->mMCON_P.mNumRow = 6UL;
  out->mMCON_P.mJc[0] = 0;
  out->mMCON_P.mJc[1] = 1;
  out->mMCON_P.mJc[2] = 2;
  out->mMCON_P.mJc[3] = 3;
...
{
  (void)t1;
  out->mICRM_P.mNumCol = 6UL;
  out->mICRM_P.mNumRow = 4UL;
  out->mICRM_P.mJc[0] = 0;
  out->mICRM_P.mJc[1] = 0;
  out->mICRM_P.mJc[2] = 0;
  out->mICRM_P.mJc[3] = 0;
...
static int32_T ds_dxicr_p (const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[7] = { 0, 0, 1, 1, 1, 1, 1 };

  (void)t1;
  out->mDXICR_P.mNumCol = 6UL;
  out->mDXICR_P.mNumRow = 4UL;
  ...
  *t1, NeDsMethodOutput *out)
{
  ...
  static int32_T _cg_const_2[3] = { 4, 0, 1 };

  (void)t1;
  out->mTDUF_P.mNumCol = 2UL;
  out->mTDUF_P.mNumRow = 6UL;
...
{
  (void)t5;
  out->mBCON.mX[1UL] = 7.897268270691758E-12;
  out->mBCON.mX[2UL] = -0.9999999993;
  out->mBCON.mX[0UL] = -0.3333333333333333;
  (void)sys;
  (void)out;
  return 0;
}
...
{
  (void)t1;
  out->mAPAR_P.mNumCol = 6UL;
  out->mAPAR_P.mNumRow = 6UL;
  out->mAPAR_P.mJc[0] = 0;
  out->mAPAR_P.mJc[1] = 0;
  out->mAPAR_P.mJc[2] = 0;
  out->mAPAR_P.mJc[3] = 0;
  ...
  *t13, NeDsMethodOutput *out)
{
  ...
  size_t t7;
  (void)t13;
  out->mACON.mX[0UL] = 0.007897268270691758;
  out->mACON.mX[1UL] = 0.6999999995099999;
  t2[0UL] = -5.548642598977104E-7;
  t2[1UL] = 0.007897268270691758;
  t2[2UL] = 1.0;
  t2[3UL] = -0.0007851851851851851;
  t2[4UL] = -0.00023555555555555556;
  t3[0UL] = 0.0023555555555555556;
  t3[1UL] = 1.0;
  t3[2UL] = 6.666666666666667;
  t3[3UL] = 1.0;
  for (t7 = 0UL; t7 < 5UL; t7++) {
    out->mACON.mX[t7 + 2UL] = t2[t7];
  }

  for (t7 = 0UL; t7 < 4UL; t7++) {
    out->mACON.mX[t7 + 7UL] = t3[t7];
  }

  out->mACON.mX[11UL] = -7.066666666666666;
  out->mACON.mX[12UL] = -10000.0;
  (void)sys;
  (void)out;
  return 0;
}
...
{
  (void)t1;
  out->mDXF_P.mNumCol = 6UL;
  out->mDXF_P.mNumRow = 6UL;
  out->mDXF_P.mJc[0] = 0;
  out->mDXF_P.mJc[1] = 0;
  out->mDXF_P.mJc[2] = 0;
  out->mDXF_P.mJc[3] = 0;
