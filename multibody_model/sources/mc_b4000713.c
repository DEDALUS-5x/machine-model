...
#include "mc_std_fwd.h"
#include "mc_std.h"
McLinearAlgebraFactory const*mc_VstO7CZHJVG7WD56o3ixZG(void);
#include "pm_std.h"
#include "pm_std.h"
#include "pm_std.h"
...
pm_FbYb_iLqY2hwZTVlVaiqJY);struct McLinearAlgebraDataTag{PmSparsityPattern
const*mPattern;PmSparsityPattern*mc_F6c6SMT_OVSNguJ7dckA7H;PmRealVector*
mc_F6FawrfE1_W8ce8AliQNuE;mc__mPsQ8V6SzW4c97L9cFyiT*mc_FobFX43y9iOubDC_5c4pla;
};static McLinearAlgebraData*mc__ulKzZm5hA4T_iKGnjQqKP(PmAllocator*a,
PmSparsityPattern const*pm__lqjegyKuwStj56WZLiC_e){McLinearAlgebraData*d=(
McLinearAlgebraData*)(((a)->mCallocFcn((a),(sizeof(McLinearAlgebraData)),(1)))
);d->mPattern=pm__lqjegyKuwStj56WZLiC_e;d->mc_F6c6SMT_OVSNguJ7dckA7H=
mc_kAZzxJsz9tloc11S9uThaF(pm__lqjegyKuwStj56WZLiC_e,a);d->
mc_F6FawrfE1_W8ce8AliQNuE=pm_create_real_vector(((size_t)(((
pm__lqjegyKuwStj56WZLiC_e)->mJc[(pm__lqjegyKuwStj56WZLiC_e)->mNumCol]))),a);d
->mc_FobFX43y9iOubDC_5c4pla=mc_Vf73j5Fnw7ltjets1WrRk_(
pm__lqjegyKuwStj56WZLiC_e->mNumCol,pm__lqjegyKuwStj56WZLiC_e->mNumRow,a);
return d;}static McLinearAlgebraStatus mc_FEFvzQu07uh9emxE6Ymze_(
McLinearAlgebra*d){(void)d;return MC_LA_OK;}static McLinearAlgebraStatus
mc_V1Vtk_gaIwh3jaiP_3PXR1(McLinearAlgebra*la,real_T const*v){
McLinearAlgebraData*d=la->mPrivateData;mc_klSR73f0rO4LhXVlV6gmb7(d->
mc_F6FawrfE1_W8ce8AliQNuE->mX,d->mc_F6c6SMT_OVSNguJ7dckA7H,v,d->mPattern);
pm_kqNP_VNVXgWGcLsAqt8n_A(d->mc_FobFX43y9iOubDC_5c4pla->
mc_kXZtSGM_7S0HWXqFxFKO9Q,d->mc_F6FawrfE1_W8ce8AliQNuE,d->
mc_F6c6SMT_OVSNguJ7dckA7H);(d->mc_FobFX43y9iOubDC_5c4pla)->
mc_F8jYh1XJ10K_emvBxS7m6z((d->mc_FobFX43y9iOubDC_5c4pla),(0),(d->
mc_F6c6SMT_OVSNguJ7dckA7H->mNumCol));return MC_LA_OK;}static real_T*
mc_FaQn66Qi_V0iYuGMmd5xjd(real_T const*mc_Fjrq38q0w9WrgLyXNhsx1c){union{real_T
const*mc_Fjrq38q0w9WrgLyXNhsx1c;real_T*mc_kIm3LiXDCKxeWDpwRJ2Oes;}u;u.
mc_Fjrq38q0w9WrgLyXNhsx1c=mc_Fjrq38q0w9WrgLyXNhsx1c;return u.
mc_kIm3LiXDCKxeWDpwRJ2Oes;}static McLinearAlgebraStatus
mc_Fx9aOJ297s81beemiWtnqk(McLinearAlgebra*la,real_T const*v,real_T*x,real_T
const*y){McLinearAlgebraData*d=la->mPrivateData;PmRealVector
mc_VnIU3pm_im4PdeIcvHeFon;PmRealVector mc_k2mR0INwQSCheHKCBKnq6o;(void)v;
mc_VnIU3pm_im4PdeIcvHeFon.mN=d->mPattern->mNumCol;mc_VnIU3pm_im4PdeIcvHeFon.mX
=x;mc_k2mR0INwQSCheHKCBKnq6o.mN=d->mPattern->mNumRow;mc_k2mR0INwQSCheHKCBKnq6o
.mX=mc_FaQn66Qi_V0iYuGMmd5xjd(y);(d->mc_FobFX43y9iOubDC_5c4pla)->mSolve((d->
mc_FobFX43y9iOubDC_5c4pla),(&mc_VnIU3pm_im4PdeIcvHeFon),(&
mc_k2mR0INwQSCheHKCBKnq6o));return MC_LA_OK;}static real_T
mc__7lK9ae7wh4FaqcvPXOkmP(McLinearAlgebra const*la,boolean_T const
mc_FUdXx2ElPJW_d1ydSbxpdO){McLinearAlgebraData*d=la->mPrivateData;(void)
mc_FUdXx2ElPJW_d1ydSbxpdO;return(d->mc_FobFX43y9iOubDC_5c4pla)->
mc_kuJm9J2opvOrWLNs_OadzE((d->mc_FobFX43y9iOubDC_5c4pla));}static size_t
mc_VGmBkzO1j_dIZeqsL_k1be(McLinearAlgebra const*la){(void)la;(void)0;return 0;
}static void mc_kg7w0NJD40SzXa2AjKYcI2(McLinearAlgebra*la){(void)la;}static
void mc_k6o6JP_J9XplV9_1iX7wE_(McLinearAlgebra*la){McLinearAlgebraData*d=la->
mPrivateData;PmAllocator*a=pm_default_allocator();pm_VYooJBURCwKrVu6RXzQZ_5(d
->mc_F6c6SMT_OVSNguJ7dckA7H,a);pm_destroy_real_vector(d->
mc_F6FawrfE1_W8ce8AliQNuE,a);d->mc_FobFX43y9iOubDC_5c4pla->mDestroy(d->
mc_FobFX43y9iOubDC_5c4pla);{void*const mc_FVh6FsKAZwtAXy_X6SZbMy=(d);
PmAllocator*const mc_VeUiO_Svs7W3XiyzgqyXIt=(a);if(mc_FVh6FsKAZwtAXy_X6SZbMy){
(mc_VeUiO_Svs7W3XiyzgqyXIt)->mFreeFcn(mc_VeUiO_Svs7W3XiyzgqyXIt,
mc_FVh6FsKAZwtAXy_X6SZbMy);}};{void*const mc_FovXSrFyka44d9S_YvlrU5=(la);
PmAllocator*const mc_kOgmZshDTSCMg1kxHeqBg7=(a);if(mc_FovXSrFyka44d9S_YvlrU5){
(mc_kOgmZshDTSCMg1kxHeqBg7)->mFreeFcn(mc_kOgmZshDTSCMg1kxHeqBg7,
mc_FovXSrFyka44d9S_YvlrU5);}};}static McLinearAlgebraStatus
mc__Z08wvCXftWEXahxEMZd8Z(McLinearAlgebraFactory const*
...
mc__RtkHrrPEelBbDRCt5cBnV;la->mPrivateData=mc__ulKzZm5hA4T_iKGnjQqKP(
mc_FOGg0ZWot2WdYenO8zaD4Z,mc__srK5LmyWw42ZyPnbOWDWJ);la->mFactor= &
mc_V1Vtk_gaIwh3jaiP_3PXR1;la->mSolve= &mc_Fx9aOJ297s81beemiWtnqk;la->mCondest=
&mc__7lK9ae7wh4FaqcvPXOkmP;la->mMemusage= &mc_VGmBkzO1j_dIZeqsL_k1be;la->
mRestart= &mc_kg7w0NJD40SzXa2AjKYcI2;la->mDestructor= &
mc_k6o6JP_J9XplV9_1iX7wE_;(void)mc_VLfhtrJkZcWwhmTdEnSnSd;result=
mc_FEFvzQu07uh9emxE6Ymze_(la);if(result!=MC_LA_OK){return result;}*
mc_kUiN9yDkl4dshyxp7WLjGd=la;return MC_LA_OK;}static McLinearAlgebraStatus
mc_Vo48j9RNy3W8ZHORaUE7tD(McLinearAlgebraFactory const*
mc__RtkHrrPEelBbDRCt5cBnV,McLinearAlgebra**mc_kUiN9yDkl4dshyxp7WLjGd,
PmSparsityPattern const*mc__srK5LmyWw42ZyPnbOWDWJ){return
mc__Z08wvCXftWEXahxEMZd8Z(mc__RtkHrrPEelBbDRCt5cBnV,mc_kUiN9yDkl4dshyxp7WLjGd,
mc__srK5LmyWw42ZyPnbOWDWJ,mc__srK5LmyWw42ZyPnbOWDWJ->mNumCol);}
McLinearAlgebraFactory const*mc_VstO7CZHJVG7WD56o3ixZG(void){static
McLinearAlgebraFactory mc__RtkHrrPEelBbDRCt5cBnV;mc__RtkHrrPEelBbDRCt5cBnV.
mCreateLinearAlgebra= &mc_Vo48j9RNy3W8ZHORaUE7tD;mc__RtkHrrPEelBbDRCt5cBnV.
