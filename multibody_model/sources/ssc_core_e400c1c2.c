...
ssc_core_kesYKdRukKtCYLfoQ0YRJ5 ssc_core_VrvQtlpclEKjVTpcoDIr6q={{{{
...
"Failed to satisfy dynamic state constraints.",},},{{
"Internal state selector error.",
"State selector encountered a singular Jacobian.",},},{{
"Equation location is:","line %s","(no line number info)",},},};
