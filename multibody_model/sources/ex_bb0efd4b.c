...
#include "pm_std.h"
static size_t ex__sMnyaZcmZhaWeUxrpgw3G(real_T const x,real_T const*
ex_Vz4Phbp_pz4JdH7ddplnHe,size_t const n){size_t ex_kwrB3ZoKf7OufTHWaHJV7a;if(
...
ex__qUHpyapw_t__T0XS0Mrgo(real_T const*freqs,real_T const*ys,size_t const*dims
,size_t const ex__wN5g_p_uwdVVLfRtx9szc,real_T const ex_VDtn8RqdwWhs_qgUJLEtPV
,boolean_T const ex_kGoKxM6L3OlEVTfUB_F_3D,real_T*out){size_t const n1=dims[0]
;size_t const n2=dims[1];real_T const*ex_Vz4Phbp_pz4JdH7ddplnHe=freqs;real_T
const*ex_VZgn6mspCZWDhXCUyVe84F=ys;real_T const ex_F2t4dRPejYtBbDb7D3qK7c=
ex_Vz4Phbp_pz4JdH7ddplnHe[ex__wN5g_p_uwdVVLfRtx9szc-2];real_T const
...
ex_kwrB3ZoKf7OufTHWaHJV7a<n1*n2;++ex_kwrB3ZoKf7OufTHWaHJV7a){real_T const
ex__Uzvbo9F_XKie1NRF_kru_=ex_VZgn6mspCZWDhXCUyVe84F[n1*n2*(
ex__wN5g_p_uwdVVLfRtx9szc-2)+ex_kwrB3ZoKf7OufTHWaHJV7a];real_T const
...
ex_FtMgSTgOes_PYihCyfu_hn-ex_F2t4dRPejYtBbDb7D3qK7c);}else{real_T const
...
));}}}void tlu_simrf_F(real_T*out,real_T const*freqs,real_T const*ys,real_T
const*ex_V92iMZ2QonheVPFK4uIVQD,size_t const*dims){size_t const n1=dims[0];
size_t const n2=dims[1];size_t const ex__Yovi3amp7hEjLglVC5SmX=dims[2];real_T
const freq= *ex_V92iMZ2QonheVPFK4uIVQD;size_t const ex__wN5g_p_uwdVVLfRtx9szc=
...
ex_kBjdZCqdGxxriTLiPTxn4N;real_T const*freqs=(real_T const*)((void const*const
*)ex_VkFC2hfrNV8lYiAOFp8tS1)[0];real_T const*ys=(real_T const*)((void const*
const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[1];real_T const*freq=(real_T const*)((void
const*const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[2];size_t const*dims=(size_t const*)((
void const*const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[3];tlu_simrf_F(out,freqs,ys,freq,
dims);}void tlu_simrf_DF(real_T*out,real_T const*freqs,real_T const*ys,real_T
const*ex_V92iMZ2QonheVPFK4uIVQD,size_t const*dims){size_t const n1=dims[0];
size_t const n2=dims[1];size_t const ex__Yovi3amp7hEjLglVC5SmX=dims[2];real_T
const freq= *ex_V92iMZ2QonheVPFK4uIVQD;size_t const ex__wN5g_p_uwdVVLfRtx9szc=
ex__sMnyaZcmZhaWeUxrpgw3G(freq,freqs,ex__Yovi3amp7hEjLglVC5SmX);if((
...
const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[1];real_T const*freq=(real_T const*)((void
const*const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[2];size_t const*dims=(size_t const*)((
void const*const*)ex_VkFC2hfrNV8lYiAOFp8tS1)[3];tlu_simrf_DF(out,freqs,ys,freq
,dims);}
