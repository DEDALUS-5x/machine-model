 ...
 */
/* machine_y_430a60f0_1_ds.c - body for module machine_y_430a60f0_1_ds */

#include "ne_ds.h"
#include "machine_y_430a60f0_1_ds_log.h"
#include "machine_y_430a60f0_1_ds_obs_act.h"
#include "machine_y_430a60f0_1_ds_obs_il.h"
#include "machine_y_430a60f0_1_ds_tdxf_p.h"
#include "machine_y_430a60f0_1_ds_obs_all.h"
#include "machine_y_430a60f0_1_ds_acon_p.h"
#include "machine_y_430a60f0_1_ds_obs_exp.h"
...
static NeEquationData s_equation_data[6] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "machine_y/Ideal Rotational Motion Sensor2", 1U, 0U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "machine_y/Inertia1", 1U, 1U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "machine_y/Rotational Spring1", 1U, 2U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "machine_y/Rotational Friction", 1U, 3U, FALSE, 1.0, "1", }, { "", 0U, 1,
    NE_EQUATION_DOMAIN_TIME, "", 4U, 4U, TRUE, 1.0, "1", }, { "", 0U, 1,
    NE_EQUATION_DOMAIN_TIME, "", 3U, 8U, TRUE, 1.0, "1", } };
...
static NeVariableData s_variable_data[6] = { { "Inertia1.w", 0U, 0,
    "machine_y/Inertia1", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor2.phi", 0U, 0,
    "machine_y/Ideal Rotational Motion Sensor2", 1.0, "1", 0.0, TRUE, FALSE, { 1,
      "1x1" }, NE_INIT_MODE_MANDATORY, "Angle", }, { "Rotational_Spring1.phi",
    0U, 0, "machine_y/Rotational Spring1", 1.0, "1", 0.0, TRUE, FALSE, { 1,
      "1x1" }, NE_INIT_MODE_MANDATORY, "Deformation", }, {
    "Rotational_Spring1.w", 0U, 0, "machine_y/Rotational Spring1", 1.0, "1", 0.0,
    FALSE, FALSE, { 1, "1x1" }, NE_INIT_MODE_NONE, "Rotational velocity", }, {
    "Inertia1.t", 0U, 0, "machine_y/Inertia1", 1.0, "1", 0.0, FALSE, FALSE, { 1,
      "1x1" }, NE_INIT_MODE_NONE, "Torque", }, { "Rotational_Friction.t", 0U, 0,
    "machine_y/Rotational Friction", 1.0, "1", 0.0, FALSE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_NONE, "Torque", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[40] = { {
    "Ideal_Rotational_Motion_Sensor2.A",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "A", }, {
    "Ideal_Rotational_Motion_Sensor2.C.w",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor2.R.w",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor2.W",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "W", }, {
    "Ideal_Rotational_Motion_Sensor2.alpha",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad/s^2", 1.0,
    "1/s^2", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "\316\261", }, {
    "Ideal_Rotational_Motion_Sensor2.phi",
    "machine_y/Ideal Rotational Motion Sensor2", { 1, "1x1" }, "rad", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angle", }, {
    "Ideal_Rotational_Motion_Sensor2_A0", "machine_y/PS-Simulink\nConverter5", {
      1, "1x1" }, "rad", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Rotational_Motion_Sensor2_A0", }, { "Ideal_Torque_Source1.C.w",
    "machine_y/Ideal Torque Source1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source1.R.w", "machine_y/Ideal Torque Source1", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source1.S", "machine_y/Ideal Torque Source1", { 1, "1x1" },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, { "Ideal_Torque_Source1.t",
    "machine_y/Ideal Torque Source1", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Ideal_Torque_Source1.w",
    "machine_y/Ideal Torque Source1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, { "Inertia1.I.w",
    "machine_y/Inertia1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Inertia1.J.w", "machine_y/Inertia1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Rotational velocity", }, { "Inertia1.w",
    "machine_y/Inertia1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Inertia1.energyStoredKinetic", "machine_y/Inertia1", { 1, "1x1" }, "J", 1.0,
    "kg*m^2/s^2", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Kinetic energy", }, { "Inertia1.t",
    "machine_y/Inertia1", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Inertia1.t_IJ",
    "machine_y/Inertia1", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "t_IJ", }, {
    "Mechanical_Rotational_Reference5.W.w",
    "machine_y/Mechanical Rotational Reference5", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Rotational_Reference6.W.w",
    "machine_y/Mechanical Rotational Reference6", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Rotational_Reference7.W.w",
    "machine_y/Mechanical Rotational Reference7", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper1.C.w", "machine_y/Rotational Damper1", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper1.R.w", "machine_y/Rotational Damper1", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper1.t", "machine_y/Rotational Damper1", { 1, "1x1" }, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Rotational_Damper1.w",
    "machine_y/Rotational Damper1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper1.powerExternalThermal", "machine_y/Rotational Damper1", {
      1, "1x1" }, "W", 1.0, "kg*m^2/s^3", NE_NOMINAL_SOURCE_NONE,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE,
    "External thermal power", }, { "Rotational_Damper1.power_dissipated",
    "machine_y/Rotational Damper1", { 1, "1x1" }, "kg*m^2/s^3", 1.0,
    "kg*m^2/s^3", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "Rotational_Friction.C.w", "machine_y/Rotational Friction", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Friction.R.w", "machine_y/Rotational Friction", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Friction.t", "machine_y/Rotational Friction", { 1, "1x1" },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Rotational_Friction.w",
    "machine_y/Rotational Friction", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Friction.powerExternalThermal", "machine_y/Rotational Friction",
  ...
  }, { "Rotational_Friction.power_dissipated", "machine_y/Rotational Friction",
      { 1, "1x1" }, "J/s", 1.0, "J/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "Rotational_Spring1.C.w", "machine_y/Rotational Spring1", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring1.R.w", "machine_y/Rotational Spring1", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring1.t", "machine_y/Rotational Spring1", { 1, "1x1" }, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Rotational_Spring1.w",
    "machine_y/Rotational Spring1", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring1.phi", "machine_y/Rotational Spring1", { 1, "1x1" },
    "rad", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE,
    TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Deformation", }, {
    "Rotational_Spring1.energyStoredElastic", "machine_y/Rotational Spring1", {
      1, "1x1" }, "J", 1.0, "J", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Elastic energy", }, {
    "Simulink_PS_Converter3_output0", "machine_y/Simulink-PS\nConverter3", { 1,
...
static NeAssertData s_assert_data[1] = { { "machine_y/Rotational Friction", 1U,
    0U, "Rotational_Friction", "foundation.mechanical.rotational.friction", TRUE,
...
static NeRange s_assert_range[1] = { {
    "foundation.mechanical.rotational.friction", 48U, 45U, 48U, 62U,
...
static NeRange s_equation_range[11] = { {
    ...
    NE_RANGE_TYPE_NORMAL, }, { "foundation.mechanical.rotational.friction", 47U,
    5U, 49U, 36U, NE_RANGE_TYPE_NORMAL, }, { "", 1U, 1U, 1U, 1U,
    NE_RANGE_TYPE_PROTECTED, }, { "foundation.mechanical.rotational.inertia",
    39U, 5U, 39U, 6U, NE_RANGE_TYPE_NORMAL, }, {
    "foundation.mechanical.rotational.inertia", 60U, 5U, 60U, 9U,
    NE_RANGE_TYPE_NORMAL, }, { "foundation.mechanical.rotational.branch", 19U,
    5U, 19U, 6U, NE_RANGE_TYPE_NORMAL, }, { "", 1U, 1U, 1U, 1U,
    NE_RANGE_TYPE_PROTECTED, }, { "foundation.mechanical.sources.torque", 30U,
    5U, 30U, 6U, NE_RANGE_TYPE_NORMAL, }, {
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mACON.mN = 11;
  out->mACON.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 11);
  return out;
}
...
NeDynamicSystem *machine_y_430a60f0_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 40;
  ds->mNumObservableElements = 34;
  ds->mNumZcs = 0;
  ds->mNumAsserts = 1;
  ds->mNumAssertRanges = 1;
  ...
  input_info[0].identifier = "Simulink_PS_Converter3_output0";
  input_info[0].size.numElements = 1;
  input_info[0].size.encodedDimensions = "1x1";
  input_info[0].name = "Simulink_PS_Converter3_output0";
  input_info[0].unit = "1";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 1;
  output_info[0].identifier = "Ideal_Rotational_Motion_Sensor2_A0";
  output_info[0].size.numElements = 1;
  output_info[0].size.encodedDimensions = "1x1";
  output_info[0].name = "Ideal_Rotational_Motion_Sensor2_A0";
  ...
  ds->mMethods[NE_DS_METHOD_ACON_P] = machine_y_430a60f0_1_ds_acon_p;
  ...
  ds->mMethods[NE_DS_METHOD_TDXF_P] = machine_y_430a60f0_1_ds_tdxf_p;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = machine_y_430a60f0_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = machine_y_430a60f0_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = machine_y_430a60f0_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = machine_y_430a60f0_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = machine_y_430a60f0_1_ds_obs_il;
...
static int32_T ds_slv (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static boolean_T _cg_const_1[6] = { false, false, false, true, true, false };
...
static int32_T ds_mcon (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static real_T _cg_const_1[3] = { -0.005, 1.0, -1.0 };
...
static int32_T ds_mcon_p (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[7] = { 0, 1, 2, 3, 3, 3, 3 };
...
static int32_T ds_dnf_v_x (const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static boolean_T _cg_const_1[6] = { true, true, true, true, false, false };
...
static int32_T ds_vmf (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static boolean_T _cg_const_1[6] = { false, false, false, true, false, false };
...
static int32_T ds_acon (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t23, NeDsMethodOutput *out)
{
  (void)t23;
  out->mACON.mX[0UL] = 1.0;
  out->mACON.mX[1UL] = -0.05;
  out->mACON.mX[5UL] = -1.0E-5;
  out->mACON.mX[6UL] = 1.0E-5;
  out->mACON.mX[2UL] = -1.0;
  out->mACON.mX[3UL] = 1.0;
  out->mACON.mX[4UL] = -1.0;
  out->mACON.mX[7UL] = -1.0;
  out->mACON.mX[8UL] = 0.001;
  out->mACON.mX[9UL] = 1.0;
  out->mACON.mX[10UL] = 0.001;
  (void)sys;
  (void)out;
  return 0;
}
...
{
  real_T t1;
  t1 = cosh(t2->mX.mX[0UL] / 0.01) * cosh(t2->mX.mX[0UL] / 0.01);
  out->mDXF.mX[0UL] = -((7.071067811865474 * pmf_exp(-(t2->mX.mX[0UL] /
    0.14142135623730953 * (t2->mX.mX[0UL] / 0.14142135623730953))) + -(t2->
    mX.mX[0UL] / 0.14142135623730953 * 7.071067811865474 * 2.0) * (t2->mX.mX[0UL]
    / 0.14142135623730953) * pmf_exp(-(t2->mX.mX[0UL] / 0.14142135623730953 *
    (t2->mX.mX[0UL] / 0.14142135623730953)))) * 0.3497465972395687 + 100.0 *
                        (1.0 / (t1 == 0.0 ? 1.0E-16 : t1)) * 0.05);
  (void)sys;
  (void)out;
  return 0;
}
...
static int32_T ds_dxf_p (const NeDynamicSystem *sys, const NeDynamicSystemInput *
  t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[7] = { 0, 1, 1, 1, 1, 1, 1 };
                     ...
                     NeDsMethodOutput *out)
{
  ...
  out->mF.mX[1UL] = -0.0;
  out->mF.mX[2UL] = -0.0;
  out->mF.mX[3UL] = -(t1->mX.mX[0UL] / 0.14142135623730953 * pmf_exp(-(t1->
    mX.mX[0UL] / 0.14142135623730953 * (t1->mX.mX[0UL] / 0.14142135623730953))) *
                      0.3497465972395687 + tanh(t1->mX.mX[0UL] / 0.01) * 0.05);
  out->mF.mX[4UL] = -0.0;
  out->mF.mX[5UL] = -0.0;
  (void)sys;
  (void)out;
...
static int32_T ds_assert (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  out->mASSERT.mX[0UL] = (int32_T)(-(t1->mX.mX[0UL] / 0.14142135623730953 *
    (t1->mX.mX[0UL] / 0.14142135623730953)) < 663.6751350333474);
  (void)sys;
  (void)out;
  return 0;
}
