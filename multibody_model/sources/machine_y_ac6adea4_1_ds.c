 ...
 */
/* machine_y_ac6adea4_1_ds.c - body for module machine_y_ac6adea4_1_ds */

#include "ne_ds.h"
#include "machine_y_ac6adea4_1_ds_log.h"
#include "machine_y_ac6adea4_1_ds_obs_act.h"
#include "machine_y_ac6adea4_1_ds_obs_il.h"
#include "machine_y_ac6adea4_1_ds_obs_all.h"
#include "machine_y_ac6adea4_1_ds_obs_exp.h"
...
static NeEquationData s_equation_data[3] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "machine_y/Ideal Rotational Motion Sensor1", 1U, 0U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "machine_y/Inertia",
    1U, 1U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "machine_y/Rotational Spring", 1U, 2U, TRUE, 1.0, "1", } };
...
static NeVariableData s_variable_data[3] = { { "Inertia.w", 0U, 0,
    "machine_y/Inertia", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor1.phi", 0U, 0,
    "machine_y/Ideal Rotational Motion Sensor1", 1.0, "1", 0.0, TRUE, FALSE, { 1,
      "1x1" }, NE_INIT_MODE_MANDATORY, "Angle", }, { "Rotational_Spring.phi", 0U,
    0, "machine_y/Rotational Spring", 1.0, "1", 0.0, TRUE, FALSE, { 1, "1x1" },
    NE_INIT_MODE_MANDATORY, "Deformation", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[45] = { {
    "Ideal_Rotational_Motion_Sensor1.A",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "A", }, {
    "Ideal_Rotational_Motion_Sensor1.C.w",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor1.R.w",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Rotational_Motion_Sensor1.W",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "W", }, {
    "Ideal_Rotational_Motion_Sensor1.alpha",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad/s^2", 1.0,
    "1/s^2", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "\316\261", }, {
    "Ideal_Rotational_Motion_Sensor1.phi",
    "machine_y/Ideal Rotational Motion Sensor1", { 1, "1x1" }, "rad", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angle", }, {
    "Ideal_Rotational_Motion_Sensor1_A0", "machine_y/PS-Simulink\nConverter3", {
      1, "1x1" }, "rad", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Ideal_Rotational_Motion_Sensor1_A0", }, { "Ideal_Torque_Sensor.C.w",
    "machine_y/Ideal Torque Sensor", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Sensor.R.w", "machine_y/Ideal Torque Sensor", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Sensor.T", "machine_y/Ideal Torque Sensor", { 1, "1x1" },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "T", }, { "Ideal_Torque_Sensor.t",
    "machine_y/Ideal Torque Sensor", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Ideal_Torque_Sensor_T0",
    "machine_y/PS-Simulink\nConverter2", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Ideal_Torque_Sensor_T0", }, {
    "Ideal_Torque_Source.C.w", "machine_y/Ideal Torque Source", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source.R.w", "machine_y/Ideal Torque Source", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source.S", "machine_y/Ideal Torque Source", { 1, "1x1" },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, { "Ideal_Torque_Source.t",
    "machine_y/Ideal Torque Source", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Ideal_Torque_Source.w",
    "machine_y/Ideal Torque Source", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, {
    "Ideal_Torque_Source2.C.w", "machine_y/Ideal Torque Source2", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source2.R.w", "machine_y/Ideal Torque Source2", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Torque_Source2.S", "machine_y/Ideal Torque Source2", { 1, "1x1" },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, { "Ideal_Torque_Source2.t",
    "machine_y/Ideal Torque Source2", { 1, "1x1" }, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Ideal_Torque_Source2.w",
    "machine_y/Ideal Torque Source2", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, { "Inertia.I.w",
    "machine_y/Inertia", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "machine_y/Mechanical Rotational Reference2", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Rotational_Reference3.W.w",
    "machine_y/Mechanical Rotational Reference3", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Mechanical_Rotational_Reference4.W.w",
    "machine_y/Mechanical Rotational Reference4", { 1, "1x1" }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper.C.w", "machine_y/Rotational Damper", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper.R.w", "machine_y/Rotational Damper", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper.t", "machine_y/Rotational Damper", { 1, "1x1" }, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Rotational_Damper.w",
    "machine_y/Rotational Damper", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Damper.powerExternalThermal", "machine_y/Rotational Damper", { 1,
  ...
  }, { "Rotational_Damper.power_dissipated", "machine_y/Rotational Damper", { 1,
    ...
    "machine_y/Rotational Spring", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring.R.w", "machine_y/Rotational Spring", { 1, "1x1" },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring.t", "machine_y/Rotational Spring", { 1, "1x1" }, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Rotational_Spring.w",
    "machine_y/Rotational Spring", { 1, "1x1" }, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Rotational_Spring.phi", "machine_y/Rotational Spring", { 1, "1x1" }, "rad",
    1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Deformation", }, {
    "Rotational_Spring.energyStoredElastic", "machine_y/Rotational Spring", { 1,
      "1x1" }, "J", 1.0, "J", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Elastic energy", }, {
    "Simulink_PS_Converter1_output0", "machine_y/Simulink-PS\nConverter1", { 1,
  ...
  }, { "Simulink_PS_Converter4_output0", "machine_y/Simulink-PS\nConverter4", {
...
static NeRange s_equation_range[3] = { {
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mACON.mN = 2;
  out->mACON.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 2);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 32;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 32);
  return out;
}
...
NeDynamicSystem *machine_y_ac6adea4_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[0].unit = "1";
  input_info[1].identifier = "Simulink_PS_Converter4_output0";
  input_info[1].size.numElements = 1;
  input_info[1].size.encodedDimensions = "1x1";
  input_info[1].name = "Simulink_PS_Converter4_output0";
  input_info[1].unit = "1";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 2;
  output_info[0].identifier = "Ideal_Rotational_Motion_Sensor1_A0";
  output_info[0].size.numElements = 1;
  output_info[0].size.encodedDimensions = "1x1";
  output_info[0].name = "Ideal_Rotational_Motion_Sensor1_A0";
  output_info[0].unit = "rad";
  output_info[1].identifier = "Ideal_Torque_Sensor_T0";
  output_info[1].size.numElements = 1;
  output_info[1].size.encodedDimensions = "1x1";
  output_info[1].name = "Ideal_Torque_Sensor_T0";
  output_info[1].unit = "N*m";
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = machine_y_ac6adea4_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = machine_y_ac6adea4_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = machine_y_ac6adea4_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = machine_y_ac6adea4_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = machine_y_ac6adea4_1_ds_obs_il;
...
{
  static int32_T _cg_const_1[4] = { 0, 0, 1, 1 };
...
static int32_T ds_mcon (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static real_T _cg_const_1[3] = { -0.05, 1.0, -1.0 };
...
static int32_T ds_tdxf_p (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[4] = { 0, 1, 1, 2 };
...
static int32_T ds_tduf_p (const NeDynamicSystem *sys, const NeDynamicSystemInput
  *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_1[3] = { 0, 2, 3 };

  static int32_T _cg_const_2[3] = { 1, 2, 1 };
  ...
  *t5, NeDsMethodOutput *out)
{
  ...
  out->mBCON.mX[1UL] = -19.999999999999996;
  ...
  *t1, NeDsMethodOutput *out)
{
  ...
  out->mACON.mX[1UL] = 199.99999999999997;
  (void)sys;
  (void)out;
  return 0;
}
