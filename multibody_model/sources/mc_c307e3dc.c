...
mc__d1alWYexptL_X5HTFhbNK->mc_kt25URGr4Cd3V9FZbFhVhy)->
mc_ko6_hiERTRldgDROOJBQCH));{size_t i=0;(void)0;;for(i=0;i<
mc__d1alWYexptL_X5HTFhbNK->mc_Vcf0sYXsGqORgDp6ALYIfy->mN;++i){
mc_VgqbsB_3R4GTjLQeEYi1Qc->mX[i]=mc__d1alWYexptL_X5HTFhbNK->
mc_V4aZHctJk4dmhudx_lbkXp->mX[mc__d1alWYexptL_X5HTFhbNK->
mc_Vcf0sYXsGqORgDp6ALYIfy->mX[i]];}}}static void const*
mc_kdRNngid7EpnVugfZ_6jfO(McMatrixFunction const*mc_k0CXwzVaibdnZiGUCx6PMZ){
...
mc_kTGPLYTAK1tvZ9sHNNEb7b,pm_FbYb_iLqY2hwZTVlVaiqJY);{void*const
mc_FxwVSg9vwzG8eLtQskT9KX=(mc__d1alWYexptL_X5HTFhbNK);PmAllocator*const
mc__QcrDUEx64pIcLN2CBuiTs=(pm_FbYb_iLqY2hwZTVlVaiqJY);if(
mc_FxwVSg9vwzG8eLtQskT9KX){(mc__QcrDUEx64pIcLN2CBuiTs)->mFreeFcn(
mc__QcrDUEx64pIcLN2CBuiTs,mc_FxwVSg9vwzG8eLtQskT9KX);}};{void*const
mc_VMlcCa8YuiO7ia8vAWh_Y9=(mc_k0CXwzVaibdnZiGUCx6PMZ);PmAllocator*const
mc_VX7NBgI1_wS3VqwF5a01Lg=(pm_FbYb_iLqY2hwZTVlVaiqJY);if(
mc_VMlcCa8YuiO7ia8vAWh_Y9){(mc_VX7NBgI1_wS3VqwF5a01Lg)->mFreeFcn(
mc_VX7NBgI1_wS3VqwF5a01Lg,mc_VMlcCa8YuiO7ia8vAWh_Y9);}};}typedef struct
...
mc_F2KWNLYDRCWdWTA3IH8cbN(void const*mc_kh0AzKGHcX8tfeDoNul_TU,void const*
mc__Oliq0seKPWShTNRpvAarb){int32_T mc__lO81KuDBk41W9Wd2wAkb0=((
mc_FCZwYCUaS3_MeqIUfGEbJK const*)mc_kh0AzKGHcX8tfeDoNul_TU)->
mc_Fe2T8cmSKIOubyp0T_0YMv;int32_T mc_kUQBO1dSP8_IVqRAUx4R8G=((
mc_FCZwYCUaS3_MeqIUfGEbJK const*)mc__Oliq0seKPWShTNRpvAarb)->
...
mc_kjWUPQN_Ui4d_enzFJIsF_->mNumRow))));{size_t i=0;if(!
...
pm_FbYb_iLqY2hwZTVlVaiqJY);for(i=0;i<mc_F8fT7naL9bOcimTADCVzTC->mN;++i){
mc_F8fT7naL9bOcimTADCVzTC->mX[i]=(int32_T)(i);}}if(!mc_VCVhWy_VaDhraHrlfFWxBa)
{mc_VCVhWy_VaDhraHrlfFWxBa=pm_create_int_vector(mc__XfQXtB6cfd9fyc_v3eEup->
mc_kjWUPQN_Ui4d_enzFJIsF_->mNumCol,pm_FbYb_iLqY2hwZTVlVaiqJY);for(i=0;i<
mc_VCVhWy_VaDhraHrlfFWxBa->mN;++i){mc_VCVhWy_VaDhraHrlfFWxBa->mX[i]=(int32_T)(
i);}}}{size_t i=0;for(i=0;i<mc_F8fT7naL9bOcimTADCVzTC->mN;++i){(void)0;;}for(i
=0;i<mc_VCVhWy_VaDhraHrlfFWxBa->mN;++i){(void)0;;}}mc_VTlukZ0iimdzge7aTGg7rl(
mc__Q_LsNUNJ30jbuh_YJ231V,0);{size_t i=0;for(i=0;i<mc_F8fT7naL9bOcimTADCVzTC->
mN;++i){if(mc_F8fT7naL9bOcimTADCVzTC->mX[i]>=0){mc__Q_LsNUNJ30jbuh_YJ231V->mX[
mc_F8fT7naL9bOcimTADCVzTC->mX[i]]++;}}}{size_t i=0;for(i=0;i<
mc__Q_LsNUNJ30jbuh_YJ231V->mN;++i){mc__VwrH8vm38lBbLw7Y85zxj[i]=
pm_create_int_vector((size_t)mc__Q_LsNUNJ30jbuh_YJ231V->mX[i],
pm_FbYb_iLqY2hwZTVlVaiqJY);}}{size_t mc_kNgcOktCtQxdYedrGvFn5i=0;size_t j=0;
for(j=0;j<mc_VCVhWy_VaDhraHrlfFWxBa->mN;++j){int32_T pm_Fr_bHKkQKFWbfi50VWd5Pw
=mc_VCVhWy_VaDhraHrlfFWxBa->mX[j];if(pm_Fr_bHKkQKFWbfi50VWd5Pw>=0){int32_T i=0
;for(i=mc__XfQXtB6cfd9fyc_v3eEup->mc_kjWUPQN_Ui4d_enzFJIsF_->mJc[
pm_Fr_bHKkQKFWbfi50VWd5Pw];i<mc__XfQXtB6cfd9fyc_v3eEup->
mc_kjWUPQN_Ui4d_enzFJIsF_->mJc[pm_Fr_bHKkQKFWbfi50VWd5Pw+1];++i){
mc_kNgcOktCtQxdYedrGvFn5i+=(size_t)mc__Q_LsNUNJ30jbuh_YJ231V->mX[
mc__XfQXtB6cfd9fyc_v3eEup->mc_kjWUPQN_Ui4d_enzFJIsF_->mIr[i]];}}}
mc__d1alWYexptL_X5HTFhbNK->mc_Vcf0sYXsGqORgDp6ALYIfy=pm_create_int_vector(
mc_kNgcOktCtQxdYedrGvFn5i,pm_FbYb_iLqY2hwZTVlVaiqJY);mc__d1alWYexptL_X5HTFhbNK
->mc_kTGPLYTAK1tvZ9sHNNEb7b=pm_create_sparsity_pattern(
mc_kNgcOktCtQxdYedrGvFn5i,mc_F8fT7naL9bOcimTADCVzTC->mN,
mc_VCVhWy_VaDhraHrlfFWxBa->mN,pm_FbYb_iLqY2hwZTVlVaiqJY);}
mc_VTlukZ0iimdzge7aTGg7rl(mc__Q_LsNUNJ30jbuh_YJ231V,0);{size_t i=0;for(i=0;i<
mc_F8fT7naL9bOcimTADCVzTC->mN;++i){int32_T pm_kplAJmOlA30feiNcOzi7oj=
mc_F8fT7naL9bOcimTADCVzTC->mX[i];if(pm_kplAJmOlA30feiNcOzi7oj>=0){
mc__VwrH8vm38lBbLw7Y85zxj[pm_kplAJmOlA30feiNcOzi7oj]->mX[
mc__Q_LsNUNJ30jbuh_YJ231V->mX[pm_kplAJmOlA30feiNcOzi7oj]++]=(int32_T)(i);}}}{
mc_FCZwYCUaS3_MeqIUfGEbJK*mc__2Lqvqq7gI05WuPnSCtEFO=(mc_FCZwYCUaS3_MeqIUfGEbJK
*)(((pm_FbYb_iLqY2hwZTVlVaiqJY)->mCallocFcn((pm_FbYb_iLqY2hwZTVlVaiqJY),(
sizeof(mc_FCZwYCUaS3_MeqIUfGEbJK)),(mc_F8fT7naL9bOcimTADCVzTC->mN))));int32_T
mc__uWX06JN6_GBZL9bT7SRqs=0;size_t j=0;for(j=0;j<mc_VCVhWy_VaDhraHrlfFWxBa->mN
;++j){int32_T pm_Fr_bHKkQKFWbfi50VWd5Pw=mc_VCVhWy_VaDhraHrlfFWxBa->mX[j];
int32_T mc__kZ1f4KXiHhnhqtNVzLiuU=0;mc__d1alWYexptL_X5HTFhbNK->
mc_kTGPLYTAK1tvZ9sHNNEb7b->mJc[j]=mc__uWX06JN6_GBZL9bT7SRqs;if(
pm_Fr_bHKkQKFWbfi50VWd5Pw>=0){int32_T i=0;for(i=mc__XfQXtB6cfd9fyc_v3eEup->
mc_kjWUPQN_Ui4d_enzFJIsF_->mJc[pm_Fr_bHKkQKFWbfi50VWd5Pw];i<
mc__XfQXtB6cfd9fyc_v3eEup->mc_kjWUPQN_Ui4d_enzFJIsF_->mJc[
pm_Fr_bHKkQKFWbfi50VWd5Pw+1];++i){int32_T mc_VHpyBvsKD1dGV56ujmmDPD=
mc__XfQXtB6cfd9fyc_v3eEup->mc_kjWUPQN_Ui4d_enzFJIsF_->mIr[i];PmIntVector const
*mc_Vt08OhBjvO_yVily_EKInZ=mc__VwrH8vm38lBbLw7Y85zxj[mc_VHpyBvsKD1dGV56ujmmDPD
];int32_T mc___kC4T6u0_SofuHhqiytyD=(int32_T)(mc_Vt08OhBjvO_yVily_EKInZ->mN);
int32_T mc_kh3C5f6ZAPlGWXfJykpWPn=0;for(mc_kh3C5f6ZAPlGWXfJykpWPn=0;
...
].mc_FrdD2uHThTpCba4iLjFVPt=i;mc__2Lqvqq7gI05WuPnSCtEFO[
mc__kZ1f4KXiHhnhqtNVzLiuU].mc_Fe2T8cmSKIOubyp0T_0YMv=mc_Vt08OhBjvO_yVily_EKInZ
->mX[mc_kh3C5f6ZAPlGWXfJykpWPn];mc__kZ1f4KXiHhnhqtNVzLiuU++;}}qsort(
mc__2Lqvqq7gI05WuPnSCtEFO,(size_t)mc__kZ1f4KXiHhnhqtNVzLiuU,sizeof(
mc_FCZwYCUaS3_MeqIUfGEbJK),mc_F2KWNLYDRCWdWTA3IH8cbN);{int32_T
mc_kh3C5f6ZAPlGWXfJykpWPn=0;for(mc_kh3C5f6ZAPlGWXfJykpWPn=0;
mc_kh3C5f6ZAPlGWXfJykpWPn<mc__kZ1f4KXiHhnhqtNVzLiuU;++
mc_kh3C5f6ZAPlGWXfJykpWPn){mc__d1alWYexptL_X5HTFhbNK->
mc_Vcf0sYXsGqORgDp6ALYIfy->mX[mc__uWX06JN6_GBZL9bT7SRqs+
mc_kh3C5f6ZAPlGWXfJykpWPn]=mc__2Lqvqq7gI05WuPnSCtEFO[mc_kh3C5f6ZAPlGWXfJykpWPn
].mc_FrdD2uHThTpCba4iLjFVPt;mc__d1alWYexptL_X5HTFhbNK->
mc_kTGPLYTAK1tvZ9sHNNEb7b->mIr[mc__uWX06JN6_GBZL9bT7SRqs+
mc_kh3C5f6ZAPlGWXfJykpWPn]=mc__2Lqvqq7gI05WuPnSCtEFO[mc_kh3C5f6ZAPlGWXfJykpWPn
].mc_Fe2T8cmSKIOubyp0T_0YMv;}}mc__uWX06JN6_GBZL9bT7SRqs+=
mc__kZ1f4KXiHhnhqtNVzLiuU;}}(void)0;;{void*const mc_kQ0I_9IDTy8sbiaJzbZMHx=(
mc__2Lqvqq7gI05WuPnSCtEFO);PmAllocator*const mc__34gOs04xJdRai00E6vzJU=(
pm_FbYb_iLqY2hwZTVlVaiqJY);if(mc_kQ0I_9IDTy8sbiaJzbZMHx){(
mc__34gOs04xJdRai00E6vzJU)->mFreeFcn(mc__34gOs04xJdRai00E6vzJU,
mc_kQ0I_9IDTy8sbiaJzbZMHx);}};}pm_destroy_int_vector(mc__Q_LsNUNJ30jbuh_YJ231V
,pm_FbYb_iLqY2hwZTVlVaiqJY);{size_t i=0;for(i=0;i<mc__XfQXtB6cfd9fyc_v3eEup->
mc_kjWUPQN_Ui4d_enzFJIsF_->mNumRow;++i){pm_destroy_int_vector(
mc__VwrH8vm38lBbLw7Y85zxj[i],pm_FbYb_iLqY2hwZTVlVaiqJY);}}{void*const
mc_kBLDVlYAlWxRZizskUaq9w=(mc__VwrH8vm38lBbLw7Y85zxj);PmAllocator*const
mc_F5pBS_Gma7lRZepRdV7pGx=(pm_FbYb_iLqY2hwZTVlVaiqJY);if(
mc_kBLDVlYAlWxRZizskUaq9w){(mc_F5pBS_Gma7lRZepRdV7pGx)->mFreeFcn(
mc_F5pBS_Gma7lRZepRdV7pGx,mc_kBLDVlYAlWxRZizskUaq9w);}};}
