...
#include "nesl_rtw.h"
#include "machine_y_4d193148_1.h"
#include "machine_y_4d193148_1_gateway.h"

void machine_y_4d193148_1_gateway(void)
{
  ...
  machine_y_4d193148_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("machine_y/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
