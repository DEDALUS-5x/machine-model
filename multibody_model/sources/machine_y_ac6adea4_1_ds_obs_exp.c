...
int32_T machine_y_ac6adea4_1_ds_obs_exp(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mOBS_EXP.mX[19] = 0.0;
  out->mOBS_EXP.mX[20] = 0.0;
  out->mOBS_EXP.mX[21] = 0.0;
  out->mOBS_EXP.mX[22] = 0.0;
  out->mOBS_EXP.mX[23] = 0.0;
  out->mOBS_EXP.mX[24] = 0.0;
  out->mOBS_EXP.mX[25] = 0.0;
  out->mOBS_EXP.mX[26] = 0.0;
  out->mOBS_EXP.mX[27] = 0.0;
  out->mOBS_EXP.mX[28] = 0.0;
  out->mOBS_EXP.mX[29] = 0.0;
  out->mOBS_EXP.mX[30] = 0.0;
  out->mOBS_EXP.mX[31] = 0.0;
  out->mOBS_EXP.mX[32] = 0.0;
  out->mOBS_EXP.mX[33] = 0.0;
  out->mOBS_EXP.mX[34] = 0.0;
  out->mOBS_EXP.mX[35] = 0.0;
  out->mOBS_EXP.mX[36] = 0.0;
  out->mOBS_EXP.mX[37] = 0.0;
  out->mOBS_EXP.mX[38] = 0.0;
  out->mOBS_EXP.mX[39] = 0.0;
  out->mOBS_EXP.mX[40] = 0.0;
  (void)sys;
  (void)out;
  return 0;
}
