...
mc_FOGg0ZWot2WdYenO8zaD4Z),(sizeof(mc__zHJTsqokd8xjuXHijLpG6)),(1))));
boolean_T*mc_FVSmPu0b7qdSjup2rVu4xv=(boolean_T*)(((mc_FOGg0ZWot2WdYenO8zaD4Z)
->mCallocFcn((mc_FOGg0ZWot2WdYenO8zaD4Z),(sizeof(boolean_T)),(
mc_F5WfvJZgg6pBiHOz_1m50n))));size_t i;for(i=0;i<mc_F5WfvJZgg6pBiHOz_1m50n;i++
){mc_FVSmPu0b7qdSjup2rVu4xv[i]=false;}mc_FTrf1ab_5kp6a9RTKMrrkU->
mc__FEEfWmB4J8LgqxWXBgpFv=false;mc_FTrf1ab_5kp6a9RTKMrrkU->
mc_FYFLZ2nkmvd_VeAE53T1_E=mc_FVSmPu0b7qdSjup2rVu4xv;mc_FTrf1ab_5kp6a9RTKMrrkU
->mc_k2JWfv8acYtBa1zEg5kgjp=mc_F5WfvJZgg6pBiHOz_1m50n;return
mc_FTrf1ab_5kp6a9RTKMrrkU;}void mc_kbfEOfn7DOGmfyLmEcjphP(
mc__zHJTsqokd8xjuXHijLpG6*mc_FTrf1ab_5kp6a9RTKMrrkU){PmAllocator*
mc_FOGg0ZWot2WdYenO8zaD4Z=pm_default_allocator();{void*const
mc_FEaCEtfFIh4OW5hkQnZDWy=(mc_FTrf1ab_5kp6a9RTKMrrkU->
mc_FYFLZ2nkmvd_VeAE53T1_E);PmAllocator*const mc__OE7LoQm3bSUfily6QvdfQ=(
mc_FOGg0ZWot2WdYenO8zaD4Z);if(mc_FEaCEtfFIh4OW5hkQnZDWy){(
mc__OE7LoQm3bSUfily6QvdfQ)->mFreeFcn(mc__OE7LoQm3bSUfily6QvdfQ,
mc_FEaCEtfFIh4OW5hkQnZDWy);}};{void*const mc_Vurmq4XJvatEVHBGwm_quG=(
mc_FTrf1ab_5kp6a9RTKMrrkU);PmAllocator*const mc_kBSOO4hFRyhfb9GCMqjgld=(
mc_FOGg0ZWot2WdYenO8zaD4Z);if(mc_Vurmq4XJvatEVHBGwm_quG){(
mc_kBSOO4hFRyhfb9GCMqjgld)->mFreeFcn(mc_kBSOO4hFRyhfb9GCMqjgld,
mc_Vurmq4XJvatEVHBGwm_quG);}};}static void mc_Fl08pQFl7ISPXyQx6Vbf1j(
mc__zHJTsqokd8xjuXHijLpG6 volatile*mc_FTrf1ab_5kp6a9RTKMrrkU,size_t id,
boolean_T mc_Fe6copTTRcKEayCm87ABO_){mc_FTrf1ab_5kp6a9RTKMrrkU->
mc_FYFLZ2nkmvd_VeAE53T1_E[id]=mc_Fe6copTTRcKEayCm87ABO_;if(id==0){while(true){
boolean_T mc_VjhYhS80mAxGbqYC1TeREr=true;size_t i;for(i=0;i<
mc_FTrf1ab_5kp6a9RTKMrrkU->mc_k2JWfv8acYtBa1zEg5kgjp;i++){if(
mc_FTrf1ab_5kp6a9RTKMrrkU->mc_FYFLZ2nkmvd_VeAE53T1_E[i]!=
mc_Fe6copTTRcKEayCm87ABO_){mc_VjhYhS80mAxGbqYC1TeREr=false;}}if(
mc_VjhYhS80mAxGbqYC1TeREr){break;}}mc_FTrf1ab_5kp6a9RTKMrrkU->
mc__FEEfWmB4J8LgqxWXBgpFv=mc_Fe6copTTRcKEayCm87ABO_;}while(
mc_FTrf1ab_5kp6a9RTKMrrkU->mc__FEEfWmB4J8LgqxWXBgpFv!=
