...
int32_T machine_y_ac6adea4_1_ds_obs_act(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t3, NeDsMethodOutput *out)
{
  ...
  out->mOBS_ACT.mX[3UL] = t3->mX.mX[0UL];
  ...
  out->mOBS_ACT.mX[19UL] = t3->mU.mX[1UL];
  out->mOBS_ACT.mX[20UL] = -t3->mU.mX[1UL];
  out->mOBS_ACT.mX[21UL] = -t3->mX.mX[0UL];
  out->mOBS_ACT.mX[25UL] = t3->mU.mX[0UL] + t3->mU.mX[1UL];
  Rotational_Damper_t = t3->mX.mX[2UL] * -9.999999999999998 + t3->mU.mX[0UL];
  out->mOBS_ACT.mX[37UL] = t3->mX.mX[2UL] * -199.99999999999997 + t3->mU.mX[0UL]
    * 19.999999999999996;
  out->mOBS_ACT.mX[0UL] = t3->mX.mX[1UL];
  out->mOBS_ACT.mX[1UL] = 0.0;
  out->mOBS_ACT.mX[2UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[5UL] = t3->mX.mX[1UL];
  out->mOBS_ACT.mX[6UL] = t3->mX.mX[1UL];
  out->mOBS_ACT.mX[7UL] = 0.0;
  out->mOBS_ACT.mX[8UL] = 0.0;
  out->mOBS_ACT.mX[9UL] = -t3->mU.mX[0UL];
  out->mOBS_ACT.mX[10UL] = -t3->mU.mX[0UL];
  out->mOBS_ACT.mX[11UL] = -t3->mU.mX[0UL];
  ...
  out->mOBS_ACT.mX[22UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[23UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[24UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[26UL] = 0.0;
  out->mOBS_ACT.mX[27UL] = 0.0;
  out->mOBS_ACT.mX[28UL] = 0.0;
  out->mOBS_ACT.mX[29UL] = 0.0;
  out->mOBS_ACT.mX[30UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[31UL] = Ideal_Torque_Source_R_w;
  out->mOBS_ACT.mX[32UL] = Rotational_Damper_t;
  out->mOBS_ACT.mX[33UL] = Rotational_Damper_t * 20.0;
  out->mOBS_ACT.mX[34UL] = t3->mX.mX[0UL];
  out->mOBS_ACT.mX[35UL] = Ideal_Torque_Source_R_w;
  out->mOBS_ACT.mX[36UL] = t3->mX.mX[2UL] * 10.0;
  out->mOBS_ACT.mX[38UL] = t3->mX.mX[2UL];
  out->mOBS_ACT.mX[39UL] = t3->mU.mX[0UL];
  out->mOBS_ACT.mX[40UL] = t3->mU.mX[1UL];
  (void)sys;
  (void)out;
  return 0;
}
