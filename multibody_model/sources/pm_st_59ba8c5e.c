...
;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_A]=0;sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_J]=0;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_W]=0;
sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_S]=0;sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_P_L]=0;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_P_I]
=0;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_P_J]=0;sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_P_R]=0;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_DP_L
]=0;sizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_DP_I]=0;sizes.mSizes[
...
NE_DYNAMIC_SYSTEM_INPUT_ID_A]=mc__XfQXtB6cfd9fyc_v3eEup->mA.mN;sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_J]=mc__XfQXtB6cfd9fyc_v3eEup->mJ.mN;sizes.mSizes[
...
pm_create_int_vector_fields(&(sysInputPtr->mA),(size_t)sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_A],pm__8zlSpb2Hixod149p2zadR);
pm_create_real_vector_fields(&(sysInputPtr->mJ),(size_t)sizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_J],pm__8zlSpb2Hixod149p2zadR);
...
sysInputPtr->mCI),pm__8zlSpb2Hixod149p2zadR);pm_V_eFnKjg5I4Uc1DwG4yU27(&(
sysInputPtr->mA),pm__8zlSpb2Hixod149p2zadR);pm_VeffaD_A8DxagH31Usec1H(&(
sysInputPtr->mJ),pm__8zlSpb2Hixod149p2zadR);pm_VeffaD_A8DxagH31Usec1H(&(
...
sysInputPtr->mDP_R),pm__8zlSpb2Hixod149p2zadR);{void*const
pm_st__Ko6xiQ9_Nh0b1mBs0_rZC=(sysInputPtr);PmAllocator*const
pm_st_FO1rWYKzrjh9aL9dUobGz4=(pm__8zlSpb2Hixod149p2zadR);if(
pm_st__Ko6xiQ9_Nh0b1mBs0_rZC){(pm_st_FO1rWYKzrjh9aL9dUobGz4)->mFreeFcn(
pm_st_FO1rWYKzrjh9aL9dUobGz4,pm_st__Ko6xiQ9_Nh0b1mBs0_rZC);}};}void
neu_dsi_equals_dsi(const NeDynamicSystemInput*destPtr,const
NeDynamicSystemInput*srcPtr){pm_VeeoZXnlJQ4u_112lGs8YD(&(destPtr->mQ),&(srcPtr
->mQ));pm_VeeoZXnlJQ4u_112lGs8YD(&(destPtr->mM),&(srcPtr->mM));pm_rv_equals_rv
...
srcPtr->mCI));pm_VeeoZXnlJQ4u_112lGs8YD(&(destPtr->mA),&(srcPtr->mA));
pm_rv_equals_rv(&(destPtr->mJ),&(srcPtr->mJ));pm_rv_equals_rv(&(destPtr->mW),&
(srcPtr->mW));pm_rv_equals_rv(&(destPtr->mS),&(srcPtr->mS));
pm_VeeoZXnlJQ4u_112lGs8YD(&(destPtr->mP_L),&(srcPtr->mP_L));
pm_VeeoZXnlJQ4u_112lGs8YD(&(destPtr->mP_I),&(srcPtr->mP_I));
...
pm_V8yYQkcd0vp_YaLM_nd75E(&(destPtr->mA),&(srcPtr->mA))&&
pm_FltUsml2sTlHZuCkbw_pdM(&(destPtr->mJ),&(srcPtr->mJ))&&
...
NE_DYNAMIC_SYSTEM_INPUT_ID_A]==mc__Oliq0seKPWShTNRpvAarb.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_A])&&(mc_kh0AzKGHcX8tfeDoNul_TU.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_J]==mc__Oliq0seKPWShTNRpvAarb.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_J])&&(mc_kh0AzKGHcX8tfeDoNul_TU.mSizes[
