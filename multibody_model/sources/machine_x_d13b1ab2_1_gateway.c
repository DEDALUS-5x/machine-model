...
#include "nesl_rtw.h"
#include "machine_x_d13b1ab2_1.h"
#include "machine_x_d13b1ab2_1_gateway.h"

void machine_x_d13b1ab2_1_gateway(void)
{
  ...
  machine_x_d13b1ab2_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("machine_x/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
