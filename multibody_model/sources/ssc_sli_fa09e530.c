...
ssc_sli_VTEHirmnm_hqbHWICkTVlT(NeDynamicSystemInput const*
ssc_sli__OzP6GQ7QKhuWTGGHKSszk,ssc_sli_VmZk8hTl6VheWiwMDRQsyS const*dae,
...
mc_VS9gg3UoKcpDjqrjuGmymC(PmRealVector const*v);void
ssc_sli_VTEHirmnm_hqbHWICkTVlT(NeDynamicSystemInput const*
ssc_sli__OzP6GQ7QKhuWTGGHKSszk,ssc_sli_VmZk8hTl6VheWiwMDRQsyS const*dae,
NeParameterBundle const*ssc_core__wmTd2KKOKd7YPG6_QANiL){PmAllocator*a=
pm_default_allocator();ssc_sli__vLsdRWt9o_uhqT7KXX2wx const*
ssc_sli_ktcdMpjvBzOSaXg_F3VqCc=dae->ssc_sli_FUA8D5ImF_4aiT9qVHs5oX;PmIntVector
...
pm_create_int_vector(dae->mSizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_DP_L],a);
ssc_sli_V_dLB4UkMIlkbms19qb8AZ=pm_create_int_vector(dae->mSizes.mSizes[
NE_DYNAMIC_SYSTEM_INPUT_ID_DP_I],a);ssc_sli_VEenmjQ9K_0rYaO0smmdu6=
pm_create_int_vector(dae->mSizes.mSizes[NE_DYNAMIC_SYSTEM_INPUT_ID_DP_J],a);
ssc_sli_kXNk20yZigSBXadVbpOZ_S=pm_create_real_vector(dae->mSizes.mSizes[
