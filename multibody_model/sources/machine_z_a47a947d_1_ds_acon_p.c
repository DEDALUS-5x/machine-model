...
int32_T machine_z_a47a947d_1_ds_acon_p(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  static int32_T _cg_const_2[14] = { 0, 5, 5, 6, 7, 3, 6, 7, 1, 6, 2, 4, 4, 6 };

  static int32_T _cg_const_1[9] = { 0, 2, 2, 3, 5, 8, 10, 12, 14 };

  (void)t1;
  out->mACON_P.mNumCol = 8UL;
  out->mACON_P.mNumRow = 8UL;
