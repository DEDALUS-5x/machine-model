...
pm__hARyx1bZBxVj1boVQqdtV,PmSizeVector const*pm__YmIqNX3g5Sub1vKK1hZQF);int_T
...
pm_kPvICtSd_wWNieTWLEBFD1;pm__6H5I5OnY3KoY5YVL6mLgG->mJc=(int32_T*)(((
pm_FbYb_iLqY2hwZTVlVaiqJY)->mCallocFcn((pm_FbYb_iLqY2hwZTVlVaiqJY),(sizeof(
int32_T)),(pm__6H5I5OnY3KoY5YVL6mLgG->mNumCol+1))));if(!(
pm__6H5I5OnY3KoY5YVL6mLgG->mJc)){pm_k4M7bSEmThKJbirXUDQgS6+=1;}else if(
pm_keOJjiAyBTtFhyWf033kni==0){pm__6H5I5OnY3KoY5YVL6mLgG->mIr=NULL;}else{
pm__6H5I5OnY3KoY5YVL6mLgG->mIr=(int32_T*)(((pm_FbYb_iLqY2hwZTVlVaiqJY)->
mCallocFcn((pm_FbYb_iLqY2hwZTVlVaiqJY),(sizeof(int32_T)),(
pm_keOJjiAyBTtFhyWf033kni))));if(!(pm__6H5I5OnY3KoY5YVL6mLgG->mIr)){
pm_k4M7bSEmThKJbirXUDQgS6+=1;}}((pm__6H5I5OnY3KoY5YVL6mLgG)->mJc[(
pm__6H5I5OnY3KoY5YVL6mLgG)->mNumCol]=(int32_T)((pm_keOJjiAyBTtFhyWf033kni)));
return pm_k4M7bSEmThKJbirXUDQgS6;}PmSparsityPattern*pm_create_sparsity_pattern
(size_t pm_keOJjiAyBTtFhyWf033kni,size_t pm_kJxontPsxndNYXwDXdE1iy,size_t
pm_kPvICtSd_wWNieTWLEBFD1,PmAllocator*pm__8zlSpb2Hixod149p2zadR){
PmSparsityPattern*pm__6H5I5OnY3KoY5YVL6mLgG=(PmSparsityPattern*)(((
pm__8zlSpb2Hixod149p2zadR)->mCallocFcn((pm__8zlSpb2Hixod149p2zadR),(sizeof(
PmSparsityPattern)),(1))));if(pm__6H5I5OnY3KoY5YVL6mLgG){if(
pm_kkW9oQAVI7Wt_9Rzuat5bx(pm__6H5I5OnY3KoY5YVL6mLgG,pm_keOJjiAyBTtFhyWf033kni,
pm_kJxontPsxndNYXwDXdE1iy,pm_kPvICtSd_wWNieTWLEBFD1,pm__8zlSpb2Hixod149p2zadR)
){{void*const pm__Ko6xiQ9_Nh0b1mBs0_rZC=(pm__6H5I5OnY3KoY5YVL6mLgG);
PmAllocator*const pm_FO1rWYKzrjh9aL9dUobGz4=(pm__8zlSpb2Hixod149p2zadR);if(
pm__Ko6xiQ9_Nh0b1mBs0_rZC){(pm_FO1rWYKzrjh9aL9dUobGz4)->mFreeFcn(
pm_FO1rWYKzrjh9aL9dUobGz4,pm__Ko6xiQ9_Nh0b1mBs0_rZC);}};
pm__6H5I5OnY3KoY5YVL6mLgG=NULL;}}return pm__6H5I5OnY3KoY5YVL6mLgG;}void
pm_kTFq3qlgTulWiT6pafkmmT(PmSparsityPattern*pm__56dBn4vKXWjZ1nclFRYZB,
PmSparsityPattern const*pm_kAWy4EaHbpxVbT_qyApDbv){(void)0;;(void)0;;(void)0;;
memcpy(pm__56dBn4vKXWjZ1nclFRYZB->mJc,pm_kAWy4EaHbpxVbT_qyApDbv->mJc,sizeof(
int32_T)*(pm__56dBn4vKXWjZ1nclFRYZB->mNumCol+1));memcpy(
pm__56dBn4vKXWjZ1nclFRYZB->mIr,pm_kAWy4EaHbpxVbT_qyApDbv->mIr,sizeof(int32_T)*
((size_t)(((pm__56dBn4vKXWjZ1nclFRYZB)->mJc[(pm__56dBn4vKXWjZ1nclFRYZB)->
mNumCol]))));}boolean_T pm__ZRI70SuGwhmamUtcsoyxS(PmSparsityPattern const*
pm__56dBn4vKXWjZ1nclFRYZB,PmSparsityPattern const*pm_kAWy4EaHbpxVbT_qyApDbv){(
...
pm_FvcKvutPfxG9Xe1kjs7gg0(PmSparsityPattern*pm__6H5I5OnY3KoY5YVL6mLgG,
PmAllocator*pm_FbYb_iLqY2hwZTVlVaiqJY){(void)0;;{void*const
pm_VA2IBSgul80za9NlumyumQ=(pm__6H5I5OnY3KoY5YVL6mLgG->mJc);PmAllocator*const
pm_V_W_Tev6_rxzWHwGdfKzL6=(pm_FbYb_iLqY2hwZTVlVaiqJY);if(
pm_VA2IBSgul80za9NlumyumQ){(pm_V_W_Tev6_rxzWHwGdfKzL6)->mFreeFcn(
pm_V_W_Tev6_rxzWHwGdfKzL6,pm_VA2IBSgul80za9NlumyumQ);}};if(
pm__6H5I5OnY3KoY5YVL6mLgG->mIr!=NULL){{void*const pm_k9K96kMTKg_yW9ccdDyV8y=(
pm__6H5I5OnY3KoY5YVL6mLgG->mIr);PmAllocator*const pm__rVAVJZsTRlVi1D9QZkvsU=(
pm_FbYb_iLqY2hwZTVlVaiqJY);if(pm_k9K96kMTKg_yW9ccdDyV8y){(
pm__rVAVJZsTRlVi1D9QZkvsU)->mFreeFcn(pm__rVAVJZsTRlVi1D9QZkvsU,
pm_k9K96kMTKg_yW9ccdDyV8y);}};}}void pm_VYooJBURCwKrVu6RXzQZ_5(
PmSparsityPattern*pm__6H5I5OnY3KoY5YVL6mLgG,PmAllocator*
pm__8zlSpb2Hixod149p2zadR){(void)0;;pm_FvcKvutPfxG9Xe1kjs7gg0(
pm__6H5I5OnY3KoY5YVL6mLgG,pm__8zlSpb2Hixod149p2zadR);{void*const
pm_VoOlMUHwMj8iaibcUVWG7X=(pm__6H5I5OnY3KoY5YVL6mLgG);PmAllocator*const
pm_VrBWzS4w48pfaqdbB_msWq=(pm__8zlSpb2Hixod149p2zadR);if(
pm_VoOlMUHwMj8iaibcUVWG7X){(pm_VrBWzS4w48pfaqdbB_msWq)->mFreeFcn(
pm_VrBWzS4w48pfaqdbB_msWq,pm_VoOlMUHwMj8iaibcUVWG7X);}};}PmSparsityPattern*
