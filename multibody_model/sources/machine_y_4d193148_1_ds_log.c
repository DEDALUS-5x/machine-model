...
int32_T machine_y_4d193148_1_ds_log(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *out)
{
  ...
  out->mLOG.mX[20UL] = -t1->mU.mX[0UL];
  out->mLOG.mX[21UL] = -t1->mX.mX[2UL];
  out->mLOG.mX[29UL] = t1->mX.mX[2UL];
  out->mLOG.mX[35UL] = ((t1->mX.mX[1UL] * 0.002355555555555555 + t1->mX.mX[2UL] *
    -20.0) + t1->mX.mX[3UL] * 30000.0) + t1->mU.mX[0UL];
  Translational_Damper_f = t1->mX.mX[1UL] * 0.0023555555555555556 + t1->mX.mX
    [2UL] * -10.0;
  Translational_Damper1_f = t1->mX.mX[2UL] * 10.0;
  out->mLOG.mX[48UL] = t1->mX.mX[1UL] * 0.00023555555555555556 - t1->mX.mX[2UL];
  out->mLOG.mX[0UL] = Controlled_Voltage_Source_i;
  out->mLOG.mX[1UL] = t1->mU.mX[1UL];
  out->mLOG.mX[2UL] = t1->mU.mX[1UL];
  out->mLOG.mX[3UL] = t1->mU.mX[1UL];
  out->mLOG.mX[4UL] = t1->mX.mX[1UL];
  out->mLOG.mX[5UL] = -Controlled_Voltage_Source_i;
  out->mLOG.mX[6UL] = t1->mU.mX[1UL];
  out->mLOG.mX[7UL] = DC_Motor_t;
  out->mLOG.mX[8UL] = t1->mU.mX[1UL];
  ...
  out->mLOG.mX[22UL] = t1->mX.mX[4UL];
  out->mLOG.mX[23UL] = t1->mX.mX[1UL];
  out->mLOG.mX[24UL] = t1->mX.mX[1UL];
  out->mLOG.mX[25UL] = t1->mX.mX[4UL];
  out->mLOG.mX[26UL] = t1->mX.mX[1UL];
  out->mLOG.mX[27UL] = t1->mX.mX[5UL];
  out->mLOG.mX[28UL] = t1->mX.mX[2UL];
  out->mLOG.mX[30UL] = t1->mX.mX[5UL];
  out->mLOG.mX[31UL] = t1->mX.mX[5UL] * 1000.0;
  out->mLOG.mX[32UL] = t1->mX.mX[2UL];
  out->mLOG.mX[33UL] = t1->mX.mX[2UL];
  out->mLOG.mX[34UL] = t1->mX.mX[2UL];
  out->mLOG.mX[36UL] = t1->mU.mX[0UL];
  out->mLOG.mX[37UL] = t1->mU.mX[1UL];
  out->mLOG.mX[38UL] = t1->mX.mX[2UL];
  out->mLOG.mX[39UL] = t1->mX.mX[1UL] * 0.00023555555555555556;
  out->mLOG.mX[40UL] = Translational_Damper_f;
  out->mLOG.mX[41UL] = Translational_Damper_f * 0.1;
  out->mLOG.mX[42UL] = t1->mX.mX[2UL];
  out->mLOG.mX[43UL] = Translational_Damper1_f;
  out->mLOG.mX[44UL] = Translational_Damper1_f * 0.1;
  out->mLOG.mX[45UL] = t1->mX.mX[2UL];
  out->mLOG.mX[46UL] = t1->mX.mX[1UL] * 0.00023555555555555556;
  out->mLOG.mX[47UL] = t1->mX.mX[3UL] * 30000.0;
  out->mLOG.mX[49UL] = t1->mX.mX[3UL];
  out->mLOG.mX[50UL] = t1->mX.mX[1UL] * 0.037037037037037035;
  out->mLOG.mX[51UL] = t1->mX.mX[1UL] * 0.00023555555555555556;
  out->mLOG.mX[52UL] = DC_Motor_t * 4245.2830188679245;
  out->mLOG.mX[53UL] = DC_Motor_t * -27.0;
  (void)sys;
  (void)out;
  return 0;
}
