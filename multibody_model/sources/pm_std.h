...
boolean_T pmf_is_finite(real_T x);
...
void pmf_warning(char const* w, ...);

void pmf_preformatted_warning(char const* id, char const* msg);

void pmf_hotlink(char* buffer, int bufferSize, char const* obj);

int pmf_vsnprintf_message(char* buffer, size_t l, char const* format, va_list arg);

int pmf_snprintf_message(char* buffer, size_t length, char const* format, ...);
