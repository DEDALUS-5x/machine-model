...
#include "nesl_rtw.h"
#include "machine_z_a47a947d_1.h"
#include "machine_z_a47a947d_1_gateway.h"

void machine_z_a47a947d_1_gateway(void)
{
  NeModelParameters modelparams = { (enum NeSolverTypeTag)0, 0.001, 0.001, FALSE,
    FALSE, 0.0001, 0.0, FALSE, FALSE, FALSE, (enum SscLoggingSettingTag)0,
    704111040.0, TRUE, FALSE };
  ...
  NeSolverParameters solverparams = { TRUE, TRUE, FALSE, FALSE, TRUE, FALSE,
    ...
    0.001, 0.001, 0.001, TRUE, (enum NeLocalSolverChoiceTag)0, TRUE, 1U, 0.0001,
  ...
  machine_z_a47a947d_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("machine_z/Solver Configuration1_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
